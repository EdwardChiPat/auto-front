...
const CardSummary = ({ data, cardWith, currency, payment }) => {
  return (
    <div className={`flex flex-col p-4 sm:${cardWith} w-full rounded-2xl border border-gray-700 bg-grisaceo-200 text-black`}>
      <div className="flex flex-col p-6">
        ...
        {payment ?
            <div className="py-2">
              <button type="submit" className="p-2 my-1 bg-grisaceo-400 text-white rounded-2xl uppercase w-full">Pagar</button>
            </div>
          :
            <div className="py-2">
              <Link href="/pago"><button type="button" className="p-2 my-1 bg-grisaceo-400 text-white rounded-2xl uppercase w-full">Comprar</button></Link>
            </div>
        }
      </div>
    </div>
